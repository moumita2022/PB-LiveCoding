...
/* import {number1} from "./variables.js" */
...
export {sum as add,multiply} //named export */
function sum(a, b) {
  return a + b;
}

var _default = sum; //default export 
...
exports.result = exports.number2 = exports.number1 = void 0;
//targeted all three input fields

/* export const number1 = document.getElementById("num1")
export const number2= document.getElementById("num2") 
...
_variables.number2.addEventListener("input", function () {
  console.log(_variables.number1.value);
  console.log(_variables.number2.value);
  _variables.result.value = (0, _math.default)(+_variables.number1.value, +_variables.number2.value);
...
},{"./math.js":"js/math.js","./variables.js":"js/variables.js","../css/style.scss":"css/style.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
